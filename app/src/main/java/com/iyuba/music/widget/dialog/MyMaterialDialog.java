...
public class MyMaterialDialog {
    ...
    private MyMaterialDialog.Builder mBuilder;
    private View mView;
    ...
    public void show() {
        ...
        ImmersiveManager.getInstance().updateImmersiveStatus(mAlertDialog);
        mHasShow = true;
    }
     ...
     */
    public MyMaterialDialog setContentView(int layoutResId) {
    ...
    public MyMaterialDialog setMessage(int resId) {
        mMessageResId = resId;
        if (mBuilder != null) {
    ...
    public MyMaterialDialog setMessage(CharSequence message) {
        mMessage = message;
        if (mBuilder != null) {
    ...
    public MyMaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        this.pId = resId;
    ...
    public MyMaterialDialog setPositiveButton(String text, final View.OnClickListener listener) {
        this.pText = text;
        this.pListener = listener;
        return this;
    }
    ...
    public MyMaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        this.nId = resId;
    ...
    public MyMaterialDialog setNegativeButton(String text, final View.OnClickListener listener) {
        this.nText = text;
        this.nListener = listener;
        return this;
    }
     ...
     */
    public MyMaterialDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mCancel = cancel;
        if (mBuilder != null) {
    ...
    public MyMaterialDialog setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
