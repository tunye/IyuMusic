...
public class DoingRequest {
    public static void exeRequest(String url, final IProtocolResponse<BaseListEntity<ArrayList<Doing>>> response) {
                ...
                public void onResponse(JSONObject jsonObject) {
                    try {
                        ...
                        if ("301".equals(resultCode)) {
                            BaseListEntity<ArrayList<Doing>> baseListEntity = new BaseListEntity<>();
