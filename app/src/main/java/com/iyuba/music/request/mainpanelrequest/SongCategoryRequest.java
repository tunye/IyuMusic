...
public class SongCategoryRequest {
    private static SongCategoryRequest instance;
    private final String originalUrl = "http://apps.iyuba.com/afterclass/getStyles.jsp";
    ...
    public String generateUrl(int curPage) {
